        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-5xl xl:leading-tight dark:text-white">
              Nhập Hàng Trung Quốc Tận Gốc, Tối Ưu Chi Phí, Vận Chuyển Nhanh
              Chóng
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-xl dark:text-gray-300">
              MBY Logistics - nền tảng đơn giản hóa mua hàng quốc tế,
              chuyên vận chuyển hàng từ Trung Quốc đến Việt Nam đảm bảo giải
              pháp hiệu quả về chi phí, xử lý đơn hàng nhanh chóng và dịch vụ
              vận chuyển tin cậy.
            </p>
